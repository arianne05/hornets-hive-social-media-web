...
<!--navigation-->
  ...
  <div class="box">
    <div class="main-content">
      <div class="header">
        <h3 style="text-align: center; color: #facb0f;"><strong>Login to Hornets</strong></h3>
      ...
      <div class="l-part">
        <form action="" method="post">
          ...
          <a style="text-decoration: none;float: right;color: #187FAB; color: #FFF ; font-size: 10px; " data-toggle="tooltip" title="Create Account!" href="signup.php">Don't have an account?</a><br><br>

          <center><button id="signin" class="btn btn-warning" name="login" style=" padding: 10px;">Login</button></center>
          <?php include("login.php"); ?>
        </form>

     <div class="logo" style="position: absolute;left: 50%;top: -45%">
