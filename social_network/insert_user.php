...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$insert = "insert into users (f_name,l_name,user_name,describe_user,Relationship,user_pass,user_email,user_country,user_gender,user_birthday,user_image,user_cover,user_reg_date,posts,recovery_account)
		values('$first_name','$last_name','$username','Hello Hornets This is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$posts','mydefaultrecovery')";
